...
INSERT INTO public.filters (id, type, min, max, project_id, field_id) VALUES (1, 'checkboxes_list', NULL, NULL, 1, 'stars');
...
INSERT INTO public.themes (id, project_id, slug, logo, favicon, root_menu_item_id, favorites_mode, explorer_mode, articles) VALUES (1, 1, 'theme', NULL, NULL, NULL, false, false, '[{"title":{"fr":"A propos"},"url":{"fr-FR":"https://example.com"}}]');
...
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, project_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (1, 0, false, false, NULL, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, project_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (2, 1, false, false, 1, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, project_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (3, 2, true, false, 2, 1,  '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'search', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, project_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (4, 3, false, false, 1, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, project_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (5, 4, false, false, 4, 1,  'teritorio teritorio-hosting', 'compact', NULL, true, NULL, '#99163a', '#99163a', NULL, ARRAY['hosting', 'hosting_resort', 'camp_site'], 'category', 1, 1, 1);
