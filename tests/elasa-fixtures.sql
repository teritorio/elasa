...
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (1, 0, false, false, NULL, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (2, 1, false, false, 1, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (3, 2, true, false, 2, 1,  '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'search', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (4, 3, false, false, 1, 1, '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (5, 4, false, false, 4, 1,  'teritorio teritorio-hosting', 'compact', NULL, true, NULL, '#99163a', '#99163a', NULL, 'hosting,hosting_resort,camp_site', 'category', 1, 1, 1);
