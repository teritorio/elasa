...
INSERT INTO public.themes (id, project_id, slug, name, description, logo_url, favicon_url, root_menu_item_id, site_url, main_url, keywords, favorites_mode, explorer_mode) VALUES (1, 1, 'theme', '{"fr": "Carte et points d''intérêts du Seignanx. Sud-Ouest des Landes"}', '{"fr": "Carte et annuaire : hébergement, restauration, loisirs, sports, balades et commerces"}', 'https://carte.seignanx.com/content/wp-content/uploads/2022/02/seignanx-com.png', 'https://carte.seignanx.com/content/wp-content/uploads/2022/03/Favicon.jpg', NULL, '{"fr":"https://carte.seignanx.com/"}', '{"fr":"https://www.seignanx.com/"}', '{"fr":""}', false, false);
...
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, slugs, name, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (1, 0, false, false, NULL, 1, '{"fr": "1"}', '{"en":"Root","fr":"Racine"}', '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, slugs, name, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (2, 1, false, false, 1, 1, '{"fr": "2"}', '{"fr":"Bloc Recherche"}', '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, slugs, name, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (3, 2, true, false, 2, 1, '{"fr": "3"}', '{"fr":"Recherche"}', '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'search', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, slugs, name, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (4, 3, false, false, 1, 1, '{"fr": "4"}', '{"fr":"bloc poi"}', '', 'compact', NULL, true, NULL, '', '', NULL, NULL, 'menu_group', NULL, NULL, NULL);
INSERT INTO public.menu_items (id, index_order, hidden, selected_by_default, parent_id, theme_id, slugs, name, icon, display_mode, search_indexed, style_merge, zoom, color_fill, color_line, href, style_class_string, type, popup_fields_id, details_fields_id, list_fields_id) VALUES (5, 4, false, false, 4, 1, '{"fr": "5"}', '{"fr":"Hébergement"}', 'teritorio teritorio-hosting', 'compact', NULL, true, NULL, '#99163a', '#99163a', NULL, 'hosting,hosting_resort,camp_site', 'category', 1, 1, 1);
