...
ALTER TABLE ONLY public.filters
    ADD CONSTRAINT filters_project_id_foreign FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.menu_items_filters
    ADD CONSTRAINT menu_items_filters_filters_id_foreign FOREIGN KEY (filters_id) REFERENCES public.filters(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.menu_items_filters
    ADD CONSTRAINT menu_items_filters_menu_items_id_foreign FOREIGN KEY (menu_items_id) REFERENCES public.menu_items(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.sources
    ADD CONSTRAINT menu_items_fk_project_id FOREIGN KEY (project_id) REFERENCES public.projects(id);
...
ALTER TABLE ONLY public.menu_items_sources
    ADD CONSTRAINT menu_items_sources_menu_items_id_foreign FOREIGN KEY (menu_items_id) REFERENCES public.menu_items(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.menu_items_sources
    ADD CONSTRAINT menu_items_sources_sources_id_foreign FOREIGN KEY (sources_id) REFERENCES public.sources(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.menu_items
    ADD CONSTRAINT menu_items_theme_id_foreign FOREIGN KEY (theme_id) REFERENCES public.themes(id);
...
ALTER TABLE ONLY public.pois
    ADD CONSTRAINT pois_source_id_foreign FOREIGN KEY (source_id) REFERENCES public.sources(id) ON DELETE SET NULL;
