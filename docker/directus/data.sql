...
78	menu_items	color_fill	\N	select-color	{"presets":[{"name":"$t:amenity","color":"#2A62AC"},{"name":"$t:catering","color":"#DB7900"},{"name":"$t:local_shop","color":"#009CB8"},{"name":"$t:craft","color":"#C58511"},{"name":"$t:culture","color":"#76009E"},{"name":"$t:culture_shopping","color":"#A04C97"},{"name":"$t:education","color":"#4076F6"},{"name":"$t:hosting","color":"#99163A"},{"name":"$t:leisure","color":"#00A757"},{"name":"$t:mobility","color":"#008ECF"},{"name":"$t:nature","color":"#8CC56F"},{"name":"$t:products","color":"#F25C05"},{"name":"$t:public_landmark","color":"#1D1D1B"},{"name":"$t:remarkable","color":"#E50980"},{"name":"$t:safety","color":"#E42224"},{"name":"$t:services","color":"#2A62AC"},{"name":"$t:services_shopping","color":"#4E7AB5"},{"name":"$t:shopping","color":"#808080"},{"name":"$t:social_services","color":"#006660"}]}	\N	\N	f	f	2	half	\N	\N	\N	f	UI	\N	\N
79	menu_items	color_line	\N	select-color	{"presets":[{"name":"$t:amenity","color":"#4E7AB5"},{"name":"$t:catering","color":"#DB7900"},{"name":"$t:local_shop","color":"#009CB8"},{"name":"$t:craft","color":"#C58511"},{"name":"$t:culture","color":"#A04C97"},{"name":"$t:culture_shopping","color":"#A04C97"},{"name":"$t:education","color":"#4076F6"},{"name":"$t:hosting","color":"#99163A"},{"name":"$t:leisure","color":"#00A757"},{"name":"$t:mobility","color":"#3B74B9"},{"name":"$t:nature","color":"#70B06A"},{"name":"$t:products","color":"#F25C05"},{"name":"$t:public_landmark","color":"#1D1D1B"},{"name":"$t:remarkable","color":"#E50980"},{"name":"$t:safety","color":"#E42224"},{"name":"$t:services","color":"#2A62AC"},{"name":"$t:services_shopping","color":"#2A62AC"},{"name":"$t:shopping","color":"#808080"},{"name":"$t:social_services","color":"#006660"}]}	\N	\N	f	f	3	half	\N	\N	\N	f	UI	\N	\N
...
bbcfb368-cce2-4dc0-b5b1-9ba49a893da8	Create Local Table	create_locale_table_elkil	create-locale-table	19	1	{"withImages":"{{$trigger.body.withImages}}","withTranslations":"{{$trigger.body.withTranslations}}","withName":"{{$trigger.body.withName}}","withDescription":"{{$trigger.body.withDescription}}","withAddr":"{{$trigger.body.withAddr}}","withContact":"{{$trigger.body.withContact}}","withThumbnail":"{{$trigger.body.withThumbnail}}"}	\N	\N	96ccf7a5-8702-4760-8c9e-b53267f234b2	2024-11-11 17:16:33.864+00	7ee01efc-e308-47e8-bf57-3dacd8ba56c5
