...
--
-- Name: pois_pois pois_pois_pois_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pois_pois
    ADD CONSTRAINT pois_pois_pois_id_foreign FOREIGN KEY (parent_pois_id) REFERENCES public.pois(id) ON DELETE CASCADE;


--
-- Name: pois_pois pois_pois_related_pois_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pois_pois
    ADD CONSTRAINT pois_pois_related_pois_id_foreign FOREIGN KEY (children_pois_id) REFERENCES public.pois(id) ON DELETE CASCADE;
