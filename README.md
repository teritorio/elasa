...
docker compose run --rm script bundle exec rake api:validate_poi -- [project_slug]
docker compose run --rm script bundle exec rake api:diff -- https://elasa.teritorio.xyz http://api:12000 seignanx tourism
```
