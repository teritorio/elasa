...
cat docker/directus/schema.sql docker/directus/data.sql docker/directus/seq.sql lib/api-01.sql | docker compose exec -T -u postgres postgres psql -v ON_ERROR_STOP=1
```
